...
/* @var $model common\models\FlowOutSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="flow-out-search">
    ...
    <?php // echo $form->field($model, 'sale_number') ?>
    ...
    <?php // echo $form->field($model, 'receiver_short') ?>
