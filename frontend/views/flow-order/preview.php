<table id="ta" border="1" cellspacing=0 style="width: 100%;border: 1px solid #eee;line-height: 24px;">
    ...
    <tr>
        <td colspan=7 align="center">订货单</td>
    </tr>
    <tr>
        <td colspan=3>供应商：<?=$datas['supplier']?></td>
        <td colspan=4>单据编号：<?=$datas['orderNumber']?></td>
    </tr>
    <tr style="">
    ...
    format = function(s, c) {
        ...
        function(m, p) { return c[p]; }) }
            return function(table, name) {
                ...
                var ctx = {worksheet: name || '<?=$datas['orderNumber']?>', table: table.innerHTML, name:'<?=$datas['orderNumber']?>', filename:'<?=$datas['orderNumber']?>'}
